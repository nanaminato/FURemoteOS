...
class ThemePaletteContract {
  static const Set<String> requiredColorTokens = {
    'AppBackground', 'ShellBackground', 'Surface', 'SurfaceRaised',
    'SurfaceSunken', 'SurfaceHover', 'SurfacePressed',
    'TextPrimary', 'TextSecondary', 'TextTertiary', 'TextDisabled',
    'TextOnAccent', 'TextOnDanger',
  ...
  static const Set<String> colorTokens = {...requiredColorTokens, ...{
    'TaskbarBackground', 'TaskbarForeground', 'StartMenuBackground',
    'WindowFrameBackground', 'WindowTitleBarBackground',
    'WindowTitleForeground', 'WindowInactiveTitleForeground',
    'OverlayScrim', 'Shadow', 'DesktopIconHover', 'DesktopIconSelected',
    'CardShadow', 'FlyoutShadow', 'DialogScrim', 'ChartGridLine',
